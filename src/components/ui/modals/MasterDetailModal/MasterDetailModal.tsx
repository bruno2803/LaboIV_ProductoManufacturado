        ...
        <div className={styles.modalContainer}>
          <div className={styles.modalContainerContent}>
            <div style={{ textAlign: "center" }}>
              <h1 style={{color:"#E66200"}}>{`${
                data ? "Editar" : "Agregar"
              } producto manufacturado`}</h1>
            </div>
            ...
            <div>
              <div style={{ textAlign: "center" }}>
                <h1 style={{color:"#E66200"}}>Receta</h1>
              </div>
              <div
                style={{
                  width: "100%",
              ...
              <div style={{ textAlign: "center" }}>
                <h1 style={{color:"#E66200"}}>Ingredientes</h1>
              </div>
              <div
                style={{
                  width: "100%",
              ...
              >
                ...
                <TextField
                  ...
                  defaultValue={10}
                />
                <Button onClick={handleNewIngredient} variant="text" sx={{color:"#E66200"}}>
                  Añadir
                </Button>
              </div>
            </div>
